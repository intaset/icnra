<?php
$my_email = "registration@icnra.com";
$errors = array();
...
Thank you for registering for ICNRA 2019. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icnra.com. You can find the copyright form here: www.2019.icnra.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icnra.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICNRA'19";

$your_headers = "From: ICNRA'19 <" . $my_email . ">";
...
<title>ICNRA'19 - Registration Form Filled!</title>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
    ...
    <p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icnra.com" class="body-link">registration@icnra.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

  <p class="body">We are looking forward to seeing you at ICNRA'19!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
    ...
    +1-613-834-9999<br>
    <a href="mailto:info@icnra.com">info@icnra.com</a></p>
    </div>
  </div>

  <div class="unit unit-s-1 unit-m-2-3 unit-l-2-3 contact">
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICNRA'19, please fill out the form below:</p>
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6Lcw9g0TAAAAAH4HnF4X6DOA7PJZuSsfTj_YCH_2"></div></center>
  <div class="cf">
